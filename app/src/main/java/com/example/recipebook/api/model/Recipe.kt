package com.example.recipebook.api.model
...
data class Recipe(
    ...
    @SerializedName("RCP_NM") val name : String, // 레시피명
    @SerializedName("ATT_FILE_NO_MAIN") val imageUrl: URL, // 대표이미지
    @SerializedName("RCP_PARTS_DTLS") val ingredient: String, // 재료
    @SerializedName("RCP_PAT2") val type: String, // 카테고리
